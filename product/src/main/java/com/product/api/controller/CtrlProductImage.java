...
public class CtrlProductImage {
	...
	public ResponseEntity<List<ProductImage>> getProductImages(@PathVariable("product_id") Integer product_id){		
		return new ResponseEntity<List<ProductImage>>(svc.getProductImages(product_id), HttpStatus.OK);
	}
	...
	public ResponseEntity<ApiResponse> uploadProductImage(@Valid @RequestBody ProductImage productImage, BindingResult bindingResult){
		...
		return new ResponseEntity<ApiResponse>(svc.createProductImage(productImage), HttpStatus.OK);
	}
	
	@DeleteMapping("/{id}")
	public ResponseEntity<ApiResponse> deleteProductImage(@PathVariable("id") Integer id){
		return new ResponseEntity<ApiResponse>(svc.deleteProductImage(id), HttpStatus.OK);
	}
